  ...
  return (
    <div className='py-5 px-5 md:px-12 lg:px-28'>
      ...
      <div className='text-center'>
        ...
        <p className='mt-10 max-w-[740px] m-auto text-xs sm:text-base'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero nulla possimus sapiente blanditiis doloremque beatae quas repellendus modi aperiam! Quod!</p>
